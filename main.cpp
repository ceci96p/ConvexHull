...
int main()
{
  ...
  convexHullFromFile("points4.txt", "out-hull_4.png");
  ...
  //intersectionFromFile("a_line.txt", "b_line.txt","out-intersection_4");
  //intersectionFromFile("poly1.txt", "poly2.txt","out-intersection_4");
